...
**Статус**: 🚧 В разработке (20% завершено)
...
**В разработке:**
- [ ] Models (Meditation, Pose, Place) ← СЛЕДУЮЩИЙ ШАГ
- [ ] Таймер медитации с выбором времени
- [ ] Сохранение медитаций (дата, время, поза, место, заметка)
- [ ] История медитаций (хронологический список)
- [ ] Apple Sign In аутентификация

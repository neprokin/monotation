...
### ⚠️ Для разработки (временная policy без авторизации)
...
**Важно**: Эта policy разрешает вставку любому пользователю. Используйте только для разработки и тестирования. Перед продакшеном удалите эту policy и настройте правильную авторизацию.

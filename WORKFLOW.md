...
- 💻 Watch Connectivity (синхронизация iPhone ↔ Watch) — **код готов, не работает в симуляторе**
- ✅ Supabase интеграция (временно, для разработки)

**Известные ограничения:**
- ⚠️ Watch Connectivity **не работает в симуляторе** (activationTimeout)
  - Причина: ограничение симуляторов Apple (WCSession не активируется)
  - Код написан правильно
  - Должно заработать на реальных iPhone + Apple Watch

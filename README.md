...
### ⌚️ watchOS App (✅ протестировано в симуляторе)
...
- 🔄 **Watch Connectivity** - синхронизация с iPhone (⚠️ только на реальных устройствах)

### ⚠️ Известные ограничения
- **Watch Connectivity не работает в симуляторе** (activationTimeout)
  - Причина: ограничение симуляторов Apple
  - Код готов, протестировать можно только на реальных iPhone + Apple Watch

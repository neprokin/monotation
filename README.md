...
- 💾 **Сохранение записей** - дата, время, длительность, поза, геолокация (координаты и адрес), заметка
- 📍 **Геолокация** - автоматическое определение места медитации с возможностью редактирования адреса
...
- 📝 **Интеграция с Obsidian** - автоматическое добавление медитаций в Markdown файл для анализа
...
- **Location**: CoreLocation (геолокация и обратное геокодирование)
- **Maps**: MapKit (отображение места медитации на карте)
...
- ✅ **Геолокация**: Автоматическое определение места медитации с возможностью редактирования адреса
- ✅ **Карта**: Отображение места медитации на интерактивной карте
...
**Версия**: 2.1 (CloudKit Migration Complete + Obsidian Integration + Geolocation)  
